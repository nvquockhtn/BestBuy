...
<div class="product-content">
    ...
    <form:form cssClass="left" modelAttribute="productModel" method="post" action="${pageContext.request.contextPath}/Product/Admin/Add.do" >
        ...
        <fieldset>
            ...
            <p>
                <input id="submit-button" type="submit" value="Create" onclick="createProduct();" />
            </p>
        </fieldset>
	</form:form>
</div>
