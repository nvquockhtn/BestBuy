...
public class ProductCompareController {
	private static final Logger logger = Logger.getLogger(ProductCompareController.class);
	...
	public String ProductCompare(Model model, HttpSession session) {
		...
		/*Begin Log*/
		logger.warn("nguoi dung so sanh san pham");
		/*End Log*/
	...
	public String AddProductToListCompare(
			@RequestParam("idProduct") Integer idProduct, Model model,
			HttpSession session) {
		...
		/*Begin Log*/
		logger.warn("nguoi dung them san pham vao so sanh, id san pham: " + idProduct);
		/*End Log*/
	...
	public String DeleteProductToListCompare(
			@RequestParam("idProduct") Integer idProduct, Model model,
			HttpSession session) {
		ArrayList<Product> listProductsCompare = GetProductsCompare(session);
		...
		/*Begin Log*/
		logger.warn("nguoi dung xoa san pham khoi so sanh, id san pham: " + idProduct);
		/*End Log*/
	...
	private int AddProductToListCompare(Integer idProduct,
	...
	private void DeleteProductFromListCompare(Integer idProduct,
			ArrayList<Product> listProductsCompare)
			throws NumberFormatException {
